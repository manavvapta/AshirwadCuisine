	 ...
	 <div className="mb-16 md:px-0 px-5">
		<div className="content">
		 <div className="md:col-span-8">
			...
			<h2 >
			 Where every detail matters <span className="text-white">-</span> from batter to final touch
			</h2>
		 </div>
		 
		 <div className="sub-content">
			<p>
			Every cake we serve reflects our obsession with detail — from the first mix to the final finish. That care is what turns a simple dessert into something truly memorable.
			</p>
